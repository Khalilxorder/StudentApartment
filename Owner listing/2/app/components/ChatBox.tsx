...
export default function ChatBox({ apartmentId, apartmentTitle, onClose, currentUserEmail }: ChatBoxProps) {
  ...
  // fetchMessages is stable here; apartmentId is the real dependency
            ...
            messages.map((msg) => {
              ...
              return (
                <div key={msg.id} className={`flex ${isOwnMessage ? 'justify-end' : 'justify-start'}`}>
                  ...
                  >
                    {!isOwnMessage && (
                      <p className="text-xs font-semibold mb-1 opacity-70">{msg.sender_email}</p>
                    )}
