...
export async function GET(request: NextRequest) {
  try {
    ...
    switch (metric) {
      case 'user_metrics':
        return await getUserMetrics(supabase, timeframe);
      case 'booking_metrics':
        return await getBookingMetrics(supabase, timeframe);
      case 'revenue_metrics':
        return await getRevenueMetrics(supabase, timeframe);
      case 'safety_metrics':
        return await getSafetyMetrics(supabase, timeframe);
      case 'engagement_metrics':
        return await getEngagementMetrics(supabase, timeframe);
      default:
        return await getDashboardOverview(supabase, timeframe);
    }
