                ...
                {apartment.image_urls && apartment.image_urls.length > 0 && (
                  <div className="relative h-48 bg-gray-200">
                    ...
                    {!apartment.is_available && (
                      <div className="absolute top-2 right-2 px-3 py-1 bg-red-500 text-white text-xs font-medium rounded-full">
                        Unavailable
                      </div>
                    )}
                    {apartment.featured && (
                      <div className="absolute top-2 left-2 px-3 py-1 bg-yellow-500 text-white text-xs font-medium rounded-full">
                        ⭐ Featured
                      </div>
                    )}
                  </div>
