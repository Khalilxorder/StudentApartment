// FILE: app/(app)/apartments/create/page.tsx
// Redirects to the proper owner listing creation flow
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow p-8">
          <div className="mb-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">List Your Apartment</h2>
            <p className="text-gray-600">
              Fill in the details below to create a new apartment listing. All fields marked with * are required.
              You need at least 3 quality photos to publish your listing.
            </p>
          </div>
