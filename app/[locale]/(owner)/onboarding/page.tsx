...
export default function OwnerOnboardingPage() {
  ...
  const skipOnboarding = async () => {
    ...
    try {
      ...
      // Mark onboarding as completed (skipped) in the profiles table
      // Try to upsert to handle case where profile doesn't exist yet
      ...
      if (updateError) {
        ...
        // Try alternative: just navigate anyway - middleware will check session
      }
