-- FILE: utils/create-apartments-table.sql
-- Run this SQL in Supabase SQL Editor to create the `apartments` table used by the project.
...
-- Grant select/insert/update/delete to anon role if you want (adjust for production)
-- GRANT SELECT, INSERT, UPDATE, DELETE ON public.apartments TO anon;
